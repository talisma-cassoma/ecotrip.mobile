    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10, width: "100%", justifyContent: "space-between" }}>
                <Button style={{ width: 80, height: 40 }} onPress={() => router.replace("/login")}>
                    <Button.Title>retrasar</Button.Title>
                </Button>
                <Button style={{ width: 80, height: 40 }} onPress={() => router.replace("/register")}>
                    <Button.Title>aceptar</Button.Title>
                </Button>
            </View>
        </View>
    );
